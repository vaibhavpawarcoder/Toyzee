...
<body class="img js-fullheight" style="background-image: url(Loginpage/images/bg.jpg);">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="login-wrap p-0">
                        ...
                        <?php if(isset($validation)): ?>
                         <span class="m-5 bg-white text-dark  p-3" style="font-size: 10px;">    <?= $validation->listErrors() ?>    </span>   
                        <?php endif; ?>

                        <?php if(session() -> getTempdata('error')): ?>
                         <span class="m-5 bg-white text-dark  p-3" style="font-size: 10px;">    <?= session() ->getTempdata('error'); ?>    </span>   
                        <?php endif; ?>
                        <?= form_open_multipart(); ?>
    ...
    <script src="Loginpage/js/popper.js"></script>
